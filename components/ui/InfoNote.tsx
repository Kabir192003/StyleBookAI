  ...
  return (
    <div ref={ref} className="relative inline-flex">
      <button
        ...
        className="flex h-5 w-5 items-center justify-center rounded-full text-app-text-muted transition-colors hover:bg-app-surface-hover hover:text-app-text"
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute left-1/2 top-full z-20 mt-2 w-56 -translate-x-1/2 rounded-lg border border-glass-panel bg-app-glass-panel p-3 text-xs leading-relaxed text-app-text-secondary shadow-app-lg backdrop-blur-xl"
          >
            {note}
          </motion.div>
        )}
