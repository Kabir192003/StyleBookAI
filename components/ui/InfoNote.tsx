      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute left-1/2 top-full z-20 mt-2 w-56 -translate-x-1/2 rounded-lg border border-app-border bg-app-surface p-3 text-xs leading-relaxed text-app-text-secondary shadow-lg"
          >
            {note}
          </motion.div>
        )}
